...
namespace WinFormsApp2
{
    public partial class Form1 : Form
    {
        ...
        private async void btnEnviar_Click(object sender, EventArgs e)
        {
            ...
            string datos = txtCidugov1.Text + "#" + txtEdad.Text+"#"+txtCuentasB.Text;
            string cuentasB = txtCuentasB.Text;
            string cedula = txtCidugov1.Text;
            string edad = txtEdad.Text;
            var requestAgregar = new requestAgregar();
            requestAgregar.Otros = datos;

            //
            byte[] bytes = File.ReadAllBytes(@"C:\rmi\pepe.txt");
            var str = new MemoryStream(bytes);
            requestAgregar.Archivos = ByteString.FromStream(str);
            //

            var resultado = await cliente1.AgregarInformacionAsync(requestAgregar);
        ...
        private void txtCuentasB_TextChanged(object sender, EventArgs e)
        {}
    }
}
